...
@Composable
fun editCreditCard(viewModel: ViewModel,goToCardsScreen:()->Unit) {
    ...
    var iCN by remember { mutableStateOf(16) }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        if (isDebit || isCredit) {
         ...
         if (isCredit && !cardNo.isEmpty() && !validFrom.isEmpty() && !validThru.isEmpty() && !creditLimit.isEmpty()  && !nametextField.isEmpty() && isKeyPadValidThru == false && isKeyPadCardNo == false && isKeyPadBalance == false && isKeyPadCreditUsed == false && isKeyPadCreditLimit == false) {
            IconButton(
                ...
                onClick = {
                    ...
                    if(viewModel.card==viewModel.selectedCard){
                        ...
                        if(creditLimit.toLong()>=viewModel.selectedCard.creditsUsed) {
                            ...
                            Toast.makeText(context,"Credit Limit Too Less", Toast.LENGTH_SHORT).show()
                        }
                    }
